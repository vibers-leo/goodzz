      ...
      <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        <section className="mb-10">
          <p className="text-base text-gray-700 leading-relaxed">
            위로(이하 &ldquo;회사&rdquo;)는 정보주체의 자유와 권리 보호를 위해 「개인정보 보호법」 및 관계 법령이 정한 바를 준수하여, 적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다. 이에 「개인정보 보호법」 제30조에 따라 정보주체에게 개인정보 처리에 관한 절차 및 기준을 안내하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3 text-base text-gray-700 leading-relaxed">
            ...
            <div className="mt-4">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>AI 굿즈 디자인 및 제작 서비스 제공</li>
                <li>상품 주문·배송·결제 처리</li>
                <li>고객 상담 및 문의 응대</li>
              </ul>
            </div>
            <div className="mt-4">
              <h3 className="text-lg font-bold text-gray-900 mb-2">3. 결제 처리</h3>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>PortOne을 통한 결제 대행 처리</li>
                <li>대금 결제·정산</li>
                <li>환불 처리</li>
              </ul>
            </div>
            <div className="mt-4">
              <h3 className="text-lg font-bold text-gray-900 mb-2">4. 민원 처리</h3>
              <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <div className="space-y-3 text-base text-gray-700 leading-relaxed">
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-xl">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div>
                  <p className="font-semibold">• 주문·배송 기록</p>
                  <p className="ml-4 text-gray-600">보유기간: 5년 (전자상거래법 준수)</p>
                </div>
                <div>
                  <p className="font-semibold">• 소비자 불만 또는 분쟁처리 기록</p>
                  <p className="ml-4 text-gray-600">보유기간: 3년 (전자상거래법 준수)</p>
                </div>
                <div>
          ...
          <div className="space-y-3 text-base text-gray-700 leading-relaxed">
            ...
            <div className="mt-4 space-y-4">
              <div className="p-4 bg-gray-50 rounded-xl">
                ...
                <p className="text-sm text-gray-600">• 선택항목: 프로필 이미지</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-xl">
                <h3 className="text-base font-bold text-gray-900 mb-2">2. 상품 주문 시</h3>
                <p className="text-sm text-gray-600">• 결제정보 (PortOne 결제대행사를 통해 처리)</p>
                <p className="text-sm text-gray-600">• 배송지 주소, 수령인 정보</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-xl">
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-xl">
              <div className="space-y-2 text-sm">
                <div className="flex justify-between py-2 border-b border-gray-200">
                  <span className="font-semibold text-gray-900">PortOne</span>
                  <span className="text-gray-600">결제 대행 및 정산</span>
                </div>
                <div className="flex justify-between py-2">
                  <span className="font-semibold text-gray-900">Google Cloud / Firebase</span>
                  <span className="text-gray-600">데이터 저장 및 호스팅</span>
                </div>
              </div>
            </div>
